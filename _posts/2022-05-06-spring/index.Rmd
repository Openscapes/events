...
**This is a professional development and leadership opportunity for environmental and Earth science research groups to develop open data science practices.**
...
**The 2022 Spring Cohort is an open call for research teams**, meaning teams do not need to be affiliated with any organization to attend, and participation is free. Learn more about [previous Champions Cohorts'](https://openscapes.github.io/events/#category:Champions_Cohort) achievements (blogs linked from each page), in particular the [CS&S Cohort](https://www.openscapes.org/blog/2021/07/13/css-cohort/) where we piloted the open call in 2021.
